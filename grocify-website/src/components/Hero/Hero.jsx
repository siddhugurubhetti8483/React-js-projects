...
const Hero = () => {
  return (
    <section className="pt-[14vh] ">
      <div className="min-h-screen max-w-[1400px] mx-auto px-5 md:px-10 flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        {/* Hero Content */}
        <div className="flex-1 text-center md:text-left">
          <span className="inline-block bg-orange-100 text-orange-500 text-sm md:text-lg  px-4 md:px-5 py-2 rounded-full">
            Export Best Quality...
          </span>
